...
import com.example.bulletinboard.account.Account
import com.example.bulletinboard.activities.DescriptionActivity
import com.example.bulletinboard.activities.EditAdsAct
import com.example.bulletinboard.activities.FilterActivity
import com.example.bulletinboard.activities.showToast
...
import com.example.bulletinboard.utils.AppMainState
import com.example.bulletinboard.utils.BillingManager
...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener, AdsRcAdapter.Listener{
    ...
    fun uiUpdate(user: FirebaseUser?){
        if(user == null){
            dialogHelper.accHelper.signInAnonymously(object: Account.Listener{
